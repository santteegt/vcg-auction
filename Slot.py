...
class Slot:
	...
	clickThruRate = 0.0	#the number of clicks expected
	price = 0.0	#price to be paid for those clicks
	profit = 0.0	#profit expected from those clicks
	bidder = None	#the Bid that wins this slot
